...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("deny", "Deny a pending dangerous command", "Session",
               gateway_only=True),
    CommandDef("skill-approve", "Approve and install a pending guarded skill", "Session",
               aliases=("skill_approve",), args_hint="<id>"),
    CommandDef("skill-deny", "Deny a pending guarded skill install", "Session",
               aliases=("skill_deny",), args_hint="<id>"),
    CommandDef("approvals", "List pending guarded skill approvals", "Session"),
